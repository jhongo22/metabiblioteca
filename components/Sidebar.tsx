...
export function Sidebar({ className, activeTab, onTabChange, chatDisabled, activeFile, files, onSelectFile, onDeleteFile }: SidebarProps) {
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex flex-col min-w-0">
                        <span className="text-xs font-medium truncate w-[140px]">
                          {file.filename}
                        </span>
                    ...
                    <button
                      ...
                      className="absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-lg text-zinc-600 hover:text-red-400 hover:bg-red-500/10 opacity-0 group-hover:opacity-100 transition-all duration-200 bg-[#09090b]/80"
